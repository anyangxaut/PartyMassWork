...
public class ContentListViewAdapter extends BaseAdapter {
    ...
    public ContentListViewAdapter(Context context, List<String> titles, List<Integer> icons) {
        this.titles = titles;
        this.icons = icons;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            holder.imageview = (ImageView)convertView.findViewById(R.id.imageview_image);
